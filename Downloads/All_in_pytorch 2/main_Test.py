...
def my_app(conf):
    ...
    output_dir = "/home/nohgab00/data/Medicament_analysis/Models/Expe2"
    ...
    best_params = {'epoch': 2000, 'activation': 'RELU', 'layers': 1, 'hidden_dim_1': 300, 'learning_rate': 0.00017087603239981984} #À remplir
    #plot new comb
    # Scatter plot of true vs predicted values
    if conf.model == 'Logistic_regression':
            model = LogisticRegression_Simple(device, num_features=num_features)
